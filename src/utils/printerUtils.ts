...
export const PRINTER_PRESETS: PrinterPreset[] = [
  {
    ...
    widthInches: 2.0,
    heightInches: 1.0,
    activeFrameWidthInches: 1.80,
    activeFrameHeightInches: 0.70,
    pageSizeCss: '2in 1in',
    dpi: 203,
    recommendedBarWidth: 2,
    recommendedBarHeight: 50,
    recommendedFontSize: 18,
    recommendedBorderWidth: 7,
    type: 'thermal_roll',
    description: '1.80" × 0.70" active inner frame fitted inside standard 2" × 1" thermal label roll.',
  },
  {
    id: 'dymo_labelwriter',
...
export function applyPrinterPreset(
  ...
  return {
    ...
    borderWidth: currentOptions.borderWidth !== undefined ? currentOptions.borderWidth : preset.recommendedBorderWidth,
  };
}
